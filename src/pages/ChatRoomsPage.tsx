...
function randomGooglePicture() {
    return (`https://material-components.github.io/material-components-web-catalog/static/media/photos/3x2/${(Math.floor(Math.random() * Math.floor(17)))}.jpg`)
}
